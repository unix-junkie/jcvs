...
CVSRequest {
	...
	*/
	...
	public void
	setUserInterface( final CVSUserInterface ui )
		{
		this.ui = ui;
		}
	...
	public void
	setDirEntry( final CVSEntry dirEntry )
		{
	 ...
	 */
	public void
	setLocalDirectory( final String localDirectory )
		{
	 ...
	 */
	public File
	getLocalFile( final CVSEntry entry )
		{
		final File result =
			new File(
					this.localDirectory + '/'
	 ...
	 */
	public void
	setRootRepository( final String repository )
		{
	 ...
	 */
	public void
	setEntries( final CVSEntryVector entries )
		{
	 ...
	 */
	public void
	setArguments( final CVSArgumentVector arguments )
		{
	 ...
	 */
	public void
	setGlobalArguments( final CVSArgumentVector arguments )
		{
	 ...
	 */
	public void
	setStickys( final Hashtable stickys )
		{
	 ...
	 */
	public void
	setStatics( final Hashtable statics )
		{
	 ...
	 */
	public void
	setCheckInProgram( final String program )
		{
	 ...
	 */
	public void
	setUpdateProgram( final String program )
		{
	...
	public void
	redirectLine( final String line )
		{
	...
	public void
	setRedirectWriter( final PrintWriter writer )
		{
		...
		if ( tokenCount >= 4 )
			...
			if ( result )
				...
				for ( i = 0 ; requestStr != null
					...
					{
					final char cmdChar = requestStr.charAt(i);
					switch ( cmdChar )
						{
				...
				for ( i = 0 ; responseStr != null
					...
					{
					final char cmdChar = responseStr.charAt(i);
					switch ( cmdChar )
						{
