...
public class SSH2Authenticator {
     ...
     * methods and associates the module with the given method name. The module
     * is added last in the current list, hence modules must be added in the
     * order of preference.
     *
     * @param method the name of the method this module implements
